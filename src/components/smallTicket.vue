<template>
  <div class="device-container">
    <el-button @click="print()" style="display:none;">打印</el-button>
...
export default {
  ...
  data() {
    return {
      ...
      payMent: "",
      qrCode:
        "https://6441ace61742439ba654b9f399be07e8-cn-hangzhou-vpc.alicloudapi.com/uinvoice/apply?BC=30006&CA=2500&CN=858011511841358848&NC=5444&SN=ums001&TN=0&TS=1625449935111&AS=88B8797A99AC39A5E0036EE33878AE65",
      baseUrl: "",
      barcode: "",
      isType: 0,
    };
  ...
  methods: {
    ...
    sendMessageSelf() {
      ...
      printer.addText(
        ("￥" + this.payable_amount / 100).padStart(11, " ") + "\n"
      );
      printer.addTextPosition(0);
    ...
    detail() {
      ...
      orderDetail(this.id).then((res) => {
        ...
        if (
          this.orderdetail.shop_no == "imperfect-test" ||
          this.orderdetail.shop_no == "" ||
          this.orderdetail.shop_no == null ||
          this.orderdetail.shop_no == undefined
        ) {
